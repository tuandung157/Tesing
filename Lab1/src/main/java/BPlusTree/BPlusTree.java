...
public class BPlusTree {
    ...
    public void insert(double key, String value) {
        ...
        // Case 2: Only one node that is not full
            ...
            // For all insertions until the root gets overfull for the first time, we just update the root node, adding the new keys
        ...
        // Case 3: Normal insert
            ...
            Node curr = this.root;
            // Since we insert the element only at the external node, we traverse to the last level
    ...
    private void insertWithinExternalNode(double key, String value, Node node) {
        // A binary search is executed to find the correct place where the node is to be inserted
